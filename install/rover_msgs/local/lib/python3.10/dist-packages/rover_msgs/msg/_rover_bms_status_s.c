...
bool rover_msgs__msg__rover_bms_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rover_msgs.msg._rover_bms_status.RoverBmsStatus", full_classname_dest, 47) == 0);
  }
  rover_msgs__msg__RoverBmsStatus * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of RoverBmsStatus */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rover_msgs.msg._rover_bms_status");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RoverBmsStatus");
