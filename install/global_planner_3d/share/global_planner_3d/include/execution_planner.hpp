...
namespace EXECUTION
{
    namespace planner
    {
        ...
        public:
            ...
            rclcpp::Publisher<visualization_msgs::msg::Marker>::SharedPtr tree_vis_pub_=NULL;
            rclcpp::Publisher<visualization_msgs::msg::Marker>::SharedPtr goal_vis_pub_=NULL;
            rclcpp::Publisher<std_msgs::msg::Float32MultiArray>::SharedPtr tree_tra_pub_=NULL;
