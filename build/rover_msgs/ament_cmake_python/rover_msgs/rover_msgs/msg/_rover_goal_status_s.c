...
bool rover_msgs__msg__rover_goal_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rover_msgs.msg._rover_goal_status.RoverGoalStatus", full_classname_dest, 49) == 0);
  }
  rover_msgs__msg__RoverGoalStatus * ros_message = _ros_message;
  {  // x
  ...
  {  // goal_id
    ...
    assert(PyLong_Check(field));
    ros_message->goal_id = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // text
...
{
  /* NOTE(esteve): Call constructor of RoverGoalStatus */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rover_msgs.msg._rover_goal_status");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RoverGoalStatus");
